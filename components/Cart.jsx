  ...
  return (
    <div className='max-w-3xl mx-auto mt-20'>
      ...
      <table className="w-full border-collapse">
        ...
        <tbody>
          {cart?.map((item) => (
            <tr key={item?.name} className="hover:bg-gray-50 text-center border-b border-gray-300 text-[#5B20B6]">
              ...
              <td className="py-2 px-4">
                <FaTrash onClick={()=>{handleRemoveFromCart(item._id)}} className="text-[#5B20B6] mx-auto cursor-pointer" />
              </td>
            </tr>
          ))}
        </tbody>
