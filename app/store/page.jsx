...
import { getProducts } from "@/sanity/lib/sanity-utils";
  ...
  return (
    <div>
      <div className="flex flex-col items-center justify-center mt-10 space-y-4">
        <h1 className="text-4xl font-bold text-[#5B20B6] text-center">Walk on the Cutting Edge</h1>
        <p className="text-center text-xl text-gray-500">Extend your possibilities with the latest, fastest, and most powerful new technology</p>
      </div>
      ...
      <div className="flex flex-col md:flex-row p-10">
        ...
        {/* Product Grid */}
        <div className='mx-auto grid grid-cols-1 lg:grid-cols-2 2xl:grid-cols-3 gap-16'>
